...
ADD COLUMN     "commentedById" TEXT NOT NULL;
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_bookmarkedById_fkey" FOREIGN KEY ("bookmarkedById") REFERENCES "User"("userId") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("postId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_commentedById_fkey" FOREIGN KEY ("commentedById") REFERENCES "User"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
